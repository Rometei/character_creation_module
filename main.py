...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет и возвращает сообщение о результате атаки"""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет и возвращает сообщение о результате защиты"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет и возвращает сообщение о результате специального умения"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает цикл тренировки персонажа"""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Запускает выбор класса с подтверждением"""
    approve_choice = None
    char_class = ''
